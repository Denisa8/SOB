...
namespace TorrentClient
{
    public class Peer
    {
        ...
        /*private*/ public byte[] buffer;
        private int counter = 0;
        private int counterRead = 0;
        public ConcurrentDictionary<int, Peer> Peers { get; } = new ConcurrentDictionary<int, Peer>();
        /*private*/public TorrentFileInfo torrent { get; set; }
        ...
        public void HandlePeerConnection(IAsyncResult ar)
        {
            ...
            Console.WriteLine("Połączenie od:  " + p + "\t(moj port: " + port + ")"); //sprawdz czy dobry port
